...
class About extends HTMLElement {
  ...
  <figure>
  <img
    src="./images/crouper-roulette.jpg"
    alt="Casino croupier - roulette"
  />
  <figcaption>
  ...
  <p>
    ...
    amateur website for a fictitious restaurant and it's menu was full of food
    which I was cooking at home at that time. I was taking photos after each
    cooked meal to use them on my experimental web project ☺️. By this time I
    was sure that I want to be a software engineer. The question was no longer
    in which field I can work in IT. The question was what programming
    language I should focus on. At that time I had chosen Java.
  </p>
  <figure>
  ...
  `;
    ...
    this._shadowRoot.querySelector("x-post").setAttribute("title", title);
    this._shadowRoot.querySelector("x-post").setAttribute("content", content);
    //the event occurred
  }
}

window.customElements.define("x-about", About);
